...
$stmt = $pdo->query("SELECT * FROM catalog WHERE category like '%Спец%'");
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><hr class="dropdown-divider" /></li>
                     <li>
                    <a class="dropdown-divider"  href="#">О нас</a>
                    </li>
                    <li>
                    <a class="dropdown-divider" а href="#">Сертификаты</a>
                    </li>
                  <li>
                    <a class="dropdown-item" href="#">Регистрация и авторизация</a>
                  </li>
